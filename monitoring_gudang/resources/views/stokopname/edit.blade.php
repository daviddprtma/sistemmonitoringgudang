...
@section('content')
    <div class="container-fluid px-2 px-md-4">
        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6 ">
            <form method="POST" action="{{ url('stokopnames/'.$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 px-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jumlah_barang" placeholder="Jumlah Barang Opname" value="{{$data->jumlah_barang}}">
                            </div>
                        </div>
                    </div>
