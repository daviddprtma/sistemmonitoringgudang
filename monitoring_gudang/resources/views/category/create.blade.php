                ...
                <div class="row gx-4 mb-2">
                    ...
                    <div class="col-12 my-auto">
                        <div class="h-100">
                            <h5 class="mb-1">
                                ...
                                <input type="text" class="form-control" name="nama_kategori" placeholder="Name"
                                    value="">
                                {{-- {{ ucfirst($cate->generic_name) }} --}}
                            </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 px-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="deskripsi_barang" placeholder="Description"
                                    value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="update ml-auto mr-auto">
                            <button type="submit" class="btn btn-primary btn-round">Add
                                category</button>
